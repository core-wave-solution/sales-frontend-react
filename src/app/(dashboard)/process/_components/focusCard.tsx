...
export function ProcessFocusCard({
  ...
  return (
    <Card className="grid h-full grid-cols-3 items-center p-6">
      ...
      <CardContent className="col-span-2 flex h-full flex-col items-center justify-between gap-3 p-0">
        ...
        <div className="grid h-full w-full grid-cols-12 gap-3">
          <div className="col-span-5 flex flex-col gap-3">
            <h4 className="text-xl font-bold text-gray-600">Ingredientes</h4>
            <div className="grid grid-cols-4 grid-rows-3 gap-3">
              {ingredients
                .filter((ingredient) => ingredient.type === "decrement")
              ...
              {ingredients
                .filter((ingredient) => ingredient.type === "increment")
                .map((ingredient, index) => (
                  <Badge variant="success" className="text-nowrap" key={index}>
          ...
          <div className="col-span-5 flex flex-col gap-3">
            <h4 className="text-xl font-bold text-gray-600">Observações</h4>
            <Textarea readOnly className="h-full w-full resize-none">
              Sem prensar
            </Textarea>
          </div>
        </div>
